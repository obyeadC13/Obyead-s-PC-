...
export default function SpotifyWidget() {
  return (
    <div className="absolute top-[108px] right-4 z-[4] hidden md:block">
      <div className="rounded-xl backdrop-blur-xl bg-black/60 border border-red-900/30 p-4 w-56">
        <div className="flex items-center gap-1 mb-3">
          <Activity size={12} className="text-green-500" />
          <span className="text-[10px] uppercase tracking-widest text-green-500/60 font-medium">Now Playing</span>
        </div>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-red-950 to-black border border-red-900/20 flex items-center justify-center">
